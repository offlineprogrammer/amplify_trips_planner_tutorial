...
class Activity extends Model {
  ...
  ActivityModelIdentifier get modelIdentifier {
    return ActivityModelIdentifier(id: id);
  }
  ...
  static final QueryModelIdentifier<ActivityModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<ActivityModelIdentifier>();
...
class ActivityModelIdentifier implements ModelIdentifier<Activity> {
  ...
  const ActivityModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ActivityModelIdentifier && id == other.id;
  }
